...
import EditorCanvasNavbar from './editor-canvas-navbar'
...
const EditorCanvas = (props: Props) => {
  ...
  return (
    <ResizablePanelGroup direction="horizontal" className='bg-neutral-100 dark:bg-black'>
      <ResizablePanel defaultSize={70}>
        <div className="flex h-full items-center justify-center">
          ...
          >
            ...
            <div className='absolute bottom-16 justify-center right-96 '>

              <EditorCanvasNavbar nodes={nodes} />
            </div>
          </div>
        </div>
      </ResizablePanel>
